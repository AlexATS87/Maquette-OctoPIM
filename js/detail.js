...
function renderTabGeneral(p){
  ...
  <div class="field-group"><div class="field-group-title">Canaux de diffusion</div>
    <div class="field-row"><div class="field-label">Actif canal O</div>
    ...
    <div class="field-row"><div class="field-label">Actif canal L</div>
      <select class="field-input form-select"
    ...
    <div class="field-row"><div class="field-label">Active (calcule)</div>
      <input class="field-input" style="background:#f0f4f8;color:#a0b0c0"
        data-calc="active_global" value="${p.fields.active_global||''}" readonly></div>
  </div></div>`;
}
