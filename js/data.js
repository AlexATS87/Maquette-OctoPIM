...
let syntheseItems = [
  ...
  { kind: 'attr',   code: 'active_o',    label: 'Actif canal O'},
  { kind: 'attr',   code: 'active_l',    label: 'Actif canal L'},
...
// ============================================================
let attrGroups = [
  { id:1,  name:'Informations generales',      code:'infos_generales',       system:false, isSynthGroup:false, isBrandGroup:false, attrIds:[1,2,3,4,5,66,67,53,59,60,61] },
  { id:2,  name:'Visuels',                     code:'visuels',               system:false, isSynthGroup:false, isBrandGroup:false, attrIds:[54,55,56,57,58] },
  { id:3,  name:'Conditions commerciales',                      code:'conditions_commerciales',                system:false, isSynthGroup:false, isBrandGroup:true,  attrIds:[6,62,63,64,65] },
...
// ============================================================
let attributes = [
  { id:1,  name:'Code SAP',         code:'sap',              type:'Texte',           groupId:1,  required:true,  calc:false, formula:'', mask:'*************', maskMin:6, showInSynth:true,  clickToOpen:false },
  ...
  { id:66, name:'Actif canal O',    code:'active_o',         type:'Oui / Non',       groupId:1,  required:false, calc:false, formula:'', mask:'', showInSynth:true,  clickToOpen:false },
  { id:67, name:'Actif canal L',    code:'active_l',         type:'Oui / Non',       groupId:1,  required:false, calc:false, formula:'', mask:'', showInSynth:true,  clickToOpen:false },
  { id:53, name:'Active',           code:'active_global',    type:'Texte calcule',   groupId:1,  required:false, calc:true,
    ...
    formulaLabel:'Actif si au moins un canal est active (canal O, canal L)',
    mask:'', showInSynth:false, clickToOpen:false },
  { id:59, name:'Statut de publication', code:'statut_publication', type:'Texte calcule', groupId:1, required:false, calc:true,
    formula:'=SI([active_o]==VRAI OU [active_l]==VRAI)',
    formulaLabel:'Publie si au moins un canal est active (canal O, canal L)',
    mask:'', showInSynth:true,  clickToOpen:false },
  { id:60, name:'Statut commercial',  code:'statut_commercial', type:'Simple select', groupId:1, required:false, calc:false, formula:'', mask:'', showInSynth:true,  clickToOpen:false,
    options:['Actif','Inactif','Ecoulement de stock','En cours','Arrêté'] },
  { id:61, name:'Code e-commerce',    code:'code_ecommerce',    type:'Texte',         groupId:1, required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false },
  ...
  { id:62, name:'RF',                  code:'rf',                  type:'Nombre',    groupId:3,  required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true },
  { id:63, name:'Remise enseigne',     code:'remiseEnseigne',      type:'Nombre',    groupId:3,  required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true, displayFormat:'percent' },
  { id:64, name:'Reprise échange',     code:'repriseEchange',      type:'Oui / Non', groupId:3,  required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true },
  { id:65, name:'Conditions de livraison', code:'conditionsLivraison', type:'Texte', groupId:3,  required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true },
  ...
  { id:17, name:'Commentaire',         code:'commentaire',   type:'Texte long',      groupId:4,  required:false, calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true },
  ...
  { id:21, name:'RFA',                 code:'rfa',           type:'Nombre',          groupId:5,  required:true,  calc:false, formula:'', mask:'', showInSynth:false, clickToOpen:false, isConditionCommerciale:true },
...
let products = [
  ...
  { id:5,  cat:'Montures',    createdAt:'02/04/2025', maj:'03/07/2025 16:20', visualSrc:null, visuals:1,
    ...
    fields:{ sap:'M906346000001', ean:'08056262361245', nom:'Monture Oakley OX8046', miseEnLigne:'10/04/2025',
             ...
             prix_catalogue:'220', active_o:'Oui', active_l:'Oui' } },
