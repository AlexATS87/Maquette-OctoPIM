...
let attributes = [
  ...
  { id:25, name:'Taux de marque',      code:'taux_marque',   type:'Nombre calcule',  groupId:5,  required:false, calc:true,
    ...
    mask:'', showInSynth:false, clickToOpen:false },
  { id:26, name:'Titre SEO O',      code:'seo_titre_o',  type:'Texte calcule', groupId:6,  required:false, calc:true, formula:'', formulaLabel:'Formule a definir avec equipe e-commerce', mask:'', showInSynth:false, clickToOpen:false },
  { id:27, name:'Description SEO O',code:'seo_desc_o',   type:'Texte calcule', groupId:6,  required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  { id:28, name:'Titre SEO L',          code:'seo_titre_l', type:'Texte calcule', groupId:6,  required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  { id:29, name:'Description SEO L',    code:'seo_desc_l',  type:'Texte calcule', groupId:6,  required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  ...
  { id:47, name:'Titre SEO O',          code:'seo_titre_o2000_l',  type:'Texte calcule', groupId:10, required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  { id:48, name:'Description SEO O',    code:'seo_desc_o2000_l',   type:'Texte calcule', groupId:10, required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  { id:49, name:'Titre SEO L',          code:'seo_titre_lissac_l', type:'Texte calcule', groupId:10, required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
  { id:50, name:'Description SEO L',    code:'seo_desc_lissac_l',  type:'Texte calcule', groupId:10, required:false, calc:true, formula:'', formulaLabel:'Formule a definir', mask:'', showInSynth:false, clickToOpen:false },
...
let brandSettings = [
  { marque:'Rip Curl',          fournisseurCode:'R00001', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0.125,  margeInterne:0.40, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Rip Curl',          fournisseurCode:'R00001', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.08,   rfa:0.125,  margeInterne:0.35, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Mauboussin',        fournisseurCode:'R00001', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0.015,  margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Mauboussin',        fournisseurCode:'R00001', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0,      rfa:0.015,  margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Cebe',              fournisseurCode:'R00020', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.08,   rfa:0.0722, margeInterne:0.20, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:"CEBE N'EST PLUS REFERENCE CHEZ BOLLE, NOUVELLE STE SOUS LE NOM DE CEBE" },
  { marque:'Bolle',             fournisseurCode:'R00020', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.08,   rfa:0.0722, margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Esprit',            fournisseurCode:'R00028', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.07,   rfa:0.09,   margeInterne:0.50, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Esprit',            fournisseurCode:'R00028', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.07,   rfa:0.09,   margeInterne:0.50, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Elle',              fournisseurCode:'R00028', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.07,   rfa:0.09,   margeInterne:0.50, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Elle',              fournisseurCode:'R00028', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.07,   rfa:0.09,   margeInterne:0.50, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Police',            fournisseurCode:'R00039', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.10,   rfa:0.08,   margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Police',            fournisseurCode:'R00039', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.10,   rfa:0.08,   margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Julbo',             fournisseurCode:'R00066', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.12,   rfa:0.0614, margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco 45€ minimum',                        commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Gucci',             fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'5% maximum du CA Net Facture Annuel' },
  { marque:'Gucci',             fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'' },
  { marque:'Chloe',             fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'5% maximum du CA Net Facture Annuel' },
  { marque:'Chloe',             fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'' },
  { marque:'Puma',              fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.10,   rfa:0,      margeInterne:0.20, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'' },
  { marque:'Saint Laurent',     fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Au reel',                                   commentaire:'Ajout centralisation e-commerce' },
  { marque:'MontBlanc',         fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:false, conditionsLivraison:'Au reel',                                   commentaire:'Ajout centralisation e-commerce' },
  { marque:'Maui Jim',          fournisseurCode:'R01554', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.04,   rfa:0,      margeInterne:0.04, repriseEchange:true,  conditionsLivraison:'Franco internet / Franco 300€ magasin',     commentaire:'3% RFA si volume 30pcs atteint' },
  { marque:'Ray-Ban',           fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0,      margeInterne:0.08, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Ray-Ban',           fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Vogue',             fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.13,   rfa:0,      margeInterne:0.13, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Vogue',             fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.13,   rfa:0,      margeInterne:0.13, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Oakley',            fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Oakley',            fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Burberry',          fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Dolce&Gabbana',     fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Persol',            fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Prada',             fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'Plus de remise e-commerce - Mail Ludmila 22/07/2025' },
  { marque:'Prada',             fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'Plus de remise e-commerce - Mail Ludmila 22/07/2025' },
  { marque:'Versace',           fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Emporio Armani',    fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Michael Kors',      fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Swarovski',         fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Moncler',           fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0,      margeInterne:0,    repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'Plus de remise e-commerce - Mail Ludmila 22/07/2025' },
  { marque:'Jimmy Choo',        fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Polo Ralph Lauren', fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Ralph Lauren',      fournisseurCode:'R00078', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0,      margeInterne:0.05, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Karl Lagerfeld',    fournisseurCode:'R00079', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0.0478, margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Lacoste',           fournisseurCode:'R00079', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0.0478, margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Calvin Klein',      fournisseurCode:'R00079', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0.0478, margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Nike',              fournisseurCode:'R00079', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.05,   rfa:0.0478, margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Longchamp',         fournisseurCode:'R00079', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0.0478, margeInterne:0.15, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Diesel',            fournisseurCode:'R00080', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.12,   rfa:0,      margeInterne:0.35, repriseEchange:true,  conditionsLivraison:'Franco 2 pces',                             commentaire:'' },
  { marque:'Adidas',            fournisseurCode:'R00080', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0.12,   margeInterne:0.35, repriseEchange:true,  conditionsLivraison:'Franco 2 pces',                             commentaire:'' },
  { marque:'Guess',             fournisseurCode:'R00080', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.10,   rfa:0.12,   margeInterne:0.35, repriseEchange:true,  conditionsLivraison:'Franco 2 pces',                             commentaire:'BAISSE RF 2023 DE 12% A 10%' },
  { marque:'Morgan',            fournisseurCode:'R00087', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0.121,  margeInterne:0.40, repriseEchange:true,  conditionsLivraison:'Franco 5 pces',                             commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'Morgan',            fournisseurCode:'R00087', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.08,   rfa:0.121,  margeInterne:0.37, repriseEchange:true,  conditionsLivraison:'Franco 5 pces',                             commentaire:'' },
  { marque:'Carrera',           fournisseurCode:'R00117', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.1233, rfa:0,      margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'Remise en fonction du CA opticien - plusieurs paliers' },
  { marque:'Boss',              fournisseurCode:'R00117', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.0733, rfa:0,      margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Hugo',              fournisseurCode:'R00117', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.0733, rfa:0,      margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Marc Jacobs',       fournisseurCode:'R00117', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.0733, rfa:0,      margeInterne:0.20, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Polaroid',          fournisseurCode:'R00117', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.1233, rfa:0,      margeInterne:0.24, repriseEchange:false, conditionsLivraison:'Franco',                                    commentaire:'' },
  { marque:'Vuarnet',           fournisseurCode:'R00124', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Solaire', rf:0.08,   rfa:0.054,  margeInterne:0.23, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'PAS DE VUARNET OPTIQUE EN 2023' },
  { marque:'Lancel',            fournisseurCode:'R00863', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0,      margeInterne:0.12, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'Mail Clemence 18/12/2024' },
  { marque:'Banana Moon',       fournisseurCode:'R01285', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0.08,   rfa:0,      margeInterne:0.40, repriseEchange:true,  conditionsLivraison:'Franco',                                    commentaire:'RF ET RFA 2021 MAJ PAR NC' },
  { marque:'FRENCH RETRO',      fournisseurCode:'R01785', type:'Montures', segAttrCode:'optique_solaire', segAttrValue:'Optique', rf:0,      rfa:0,      margeInterne:0.30, repriseEchange:true,  conditionsLivraison:'Franco - regroupement reassorts 1x/semaine', commentaire:'RF ET RFA 2021 MAJ PAR NC' },
];
...
let categories = [
  ...
  { id:4, name:'PEL',         code:'pel',        color:'#ef5350', groupIds:[1,2,8]          },
];
